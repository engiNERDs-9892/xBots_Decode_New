...
public class DC_Intake_Launch {
  ...
  private Servo chute = null; // ball shute
  ...
  public void InitIL() {
    ...
    chute = myOp.hardwareMap.get(Servo.class, "chute");
  ...
  public void chutePosition(double range) {
// map range to 0 .5 or .5 to 1.0
    double home = .0;
    double fifty = .35;
    double sixty = .4;
    double sixtyFive = 0.5;
    chute.setPosition(range);
