...
public class Grabber {
  ...
  public Servo intake1, intake2, wrist;
  private double intake1Power = 0, intake2Power = 0, wristPos = 0;
  ...
  /**
   * Sets the speed of the grabber wheels <br>
   * 1 full intake<br>
   * -1 full outtake
   *
   * @param power1 (-1) to 1
